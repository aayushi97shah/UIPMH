...
if(isset($_GET['id']))
{
  $su=$_GET['id'];
                                    ...
                                    $sel="SELECT * FROM test where t_id=$su;";
 ...
 <div id="display">
                    ...
                    <h2>Test</h2>
                      ...
                      <form action="#" id="add_city_form" method="post" data-parsley-validate id="city_form" >
                                            ...
                                            <input class="form-control" name="city_txt" placeholder="Please Enter Test" id="tname" value="<?php echo $data['tname_txt']  ?>" required autofocus pattern="[A-Za-z]{2,15}" title="only character"/><br>
