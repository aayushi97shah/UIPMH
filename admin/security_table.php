    ...
    $(document).ready(function() {
      ...
      $(".delete").click(function(e) {                
          ...
          var retval=confirm("are you sure you want to delete? ");
               ...
               type: "POST",
               url: "security_delete.php",             
               data:qrystrng,
              dataType: "html",  //expect html to be returned                
              success: function(response){
              window.location.href="security_table.php"          
            }
                        ...
                        <td class="extra_padding">Delete</td>
                                ...
                                <?php
                                 ...
                                 ?>
                                                ...
                                                <tr>
                                                    <td class="space_padding"><?php echo $row['sq_id']; ?></td>
                                                    <td class="space_padding"><?php echo $row['question']; ?></td>
                                                   ...
                                                   <td class="space_padding1" style="padding-left:35px !important;">
                                                    ...
                                                    {?>&nbsp;<?php }?></td>
                                                   <td class="space_padding1" style="padding-left:40px !important;"> <a  class="btn btn-default btn-circle update" href="#" id="<?php echo $row['sq_id']; ?>"><i class="fa fa-ban fa-2x"></i></a></td>
                                                  


                                                    <td class="space_padding1" style="padding-left:25px !important;"> <a  class="btn btn-block1 btn-danger1 btn-circle delete" href="#" id="<?php echo $row['sq_id']; ?>"><i class="fa fa-trash-o fa-2x"></i></a></td>
