      ...
      //  alert("hii");  //create an ajax request to load_page.php
        ...
        $.ajax({  
            ...
            success: function(response){
              alert(response);
              if(($.trim(response))=='changepasswordnext_adm.php')
          {
            alert("now change your password");
             window.location.href='changepasswordnext_adm.php';
          }
          else
          {
...
<body>
 ...
 <?php
                                   ...
                                   $sel15="SELECT * FROM adm WHERE uid_txt='".$up."'";
