                        ...
                        <td class="extra_padding">Delete</td>
                                ...
                                <?php
                                 ...
                                 ?>
                                                ...
                                                <tr>
                                                    <td class="space_padding"><?php echo $row['city_id']; ?></td>
                                                    <td class="space_padding"><?php echo $row['cname_txt']; ?></td>
                                                   ...
                                                   <td class="space_padding1" style="padding-left:35px !important;">
                                                    ...
                                                    {?>&nbsp;<?php }?></td>
                                                      ...
                                                      <td class="space_padding1" style="padding-left:40px !important;"> <a  class="btn btn-default btn-circle update" href="#" id="<?php echo $row['city_id']; ?>"><i class="fa fa-ban fa-2x"></i></a></td>



                                                    <td class="space_padding1" style="padding-left:25px !important;"> <a  class="btn btn-block1 btn-danger1 btn-circle delete" href="#" id="<?php echo $row['city_id']; ?>"><i class="fa fa-trash-o fa-2x"></i></a></td>
