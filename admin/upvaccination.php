...
$(".update").click(function(e) {                
          ...
          var update_name=$("#vname").val();
         
          var qrystrng = 'id='+update_id+'&'+'name='+update_name;
           $.ajax({    //create an ajax request to load_page.php
            type: "POST",
            url: "upvaccination_final.php",             
            data:qrystrng,
...
if(isset($_GET['id']))
{
  $su=$_GET['id'];
                                    ...
                                    $sel="SELECT * FROM vaccination where vacci_id=$su;";
 ...
 <div id="display">
                    ...
                    <h2>Vaccination</h2>
                      ...
                      <form action="#" id="add_city_form" method="post" data-parsley-validate id="city_form" >
                                            ...
                                            <input class="form-control" name="city_txt" placeholder="Please Enter Vaccination" id="vname" value="<?php echo $data['vname_txt']  ?>" required autofocus pattern="[A-Za-z]{2,15}" title="only character"/><br>
