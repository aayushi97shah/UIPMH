    ...
    $(document).ready(function() {
      ...
      $(".delete").click(function(e) {                
          ...
          var retval=confirm("are you sure you want to delete? ");
               ...
               type: "POST",
               url: "medical_delete.php",             
               data:qrystrng,
              dataType: "html",  //expect html to be returned                
              success: function(response){
              window.location.href="medical_table.php"          
            }
...
if(!isset($_SESSION['userid']))
{
  ...
  require 'common/top.php';
        ...
        $qry = "SELECT * FROM medical_store ORDER BY medi_id DESC";
        // echo $qry;
    ...
    font-size: 20px; margin-top: 20px;">
                        ...
                        <?php
                                 ...
                                 ?>
                                                  ...
                                                  <tr>
                                                    <td class=""><?php echo $row['medi_id']; ?></td>
                                                     <td class=""><?php echo $row['mname_txt']; ?>
                                                    </td>                                            
                                            ...
                                            ?>
                                                     ...
                                                     <td class=""><?php echo $row['sq_ans']; ?></td>
                                                      <?php 
                                                    ...
                                                    <td class="space_padding" <?php echo $temp ?>>
                                                      <?php echo $row['status']; ?>
                                                                                                       ...
                                                                                                       <td class="space_padding1" style="padding-left:70px;"> <a  class="btn btn-default btn-circle update" href="#" id="<?php echo $row['medi_id']; ?>"><i class="fa fa-ban fa-2x"></i></a></td>
                                                     <td class="space_padding1"> <a  class="btn btn-block1 btn-danger1 btn-circle delete" href="#" id="<?php echo $row['medi_id']; ?>"><i class="fa fa-trash-o fa-2x"></i></a></td>
