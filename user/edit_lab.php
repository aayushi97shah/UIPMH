...
$sel15="SELECT * FROM laboratory WHERE user_id='".$up."'";
                        ...
                        <div class="tab-content">
                            ...
                            <div class="doc">
                                ...
                                <form role="form" method="post" id="lreg" action="#" data-parsley-validate >
                                  ...
                                  <input type="text" class="form-control" name="lname" id="full_name" placeholder="Full Name (required)" required autofocus data-parsley-pattern="^[a-zA-Z\s]*$" title="only character" value="<?php echo $data15['lname_txt']?>" pattern="^[a-zA-Z\s]*$">
                                    </div>
