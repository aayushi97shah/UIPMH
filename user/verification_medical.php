  ...
  $(document).ready(function() {
      ...
      $("#docreg").on('submit',function(e){
        ...
        $.ajax({    //create an ajax request to load_page.php
            type: "POST",
            url: "verify_process_medical.php",             
         ...
         alert(response);
          ...
          if(($.trim(response))=='login_medical.php')
          {
            alert("inserted successfully");
             window.location.href='login_medical.php';
          }
          else
          {
                            ...
                            <div class="doc">
                                ...
                                * Please check your e-mail for the verification code   
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="code_txt" id="full_name" placeholder="Six digit code (required)" required autofocus data-parsley-pattern="^[0-9\s]*$" title="only numbers" pattern="^[0-9\s]*$">
