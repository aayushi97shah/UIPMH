...
<?php
$qry = "SELECT * FROM my_case WHERE user_id='".$uname."' ORDER BY Case_id DESC";
 $cnt=0;
...
?> <ul class="timeline animated fadeInLeft" style="-webkit-animation-duration:2s; -webkit-animation-delay:1s; ">
                        ...
                        <li  >
                           ...
                           <a href="mycase1.php?id=<?php echo $id;?>" class="delete"  style="color:#21C2F8!important;">Read More..</a>
                                </div>
