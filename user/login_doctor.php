            ...
            <div class="col-md-4 col-md-offset-4 animated bounceInDown">
                <div class="login-panel panel panel-default" style="margin-top:67px; margin-bottom: 67px;">
                    ...
                    <div class="panel-body">
                        <form role="form" action="common/checklogin_doctor.php" method="post" data-parsley-validate id="login_form">
                        ...
                        ?>
                                ...
                                <input type="submit" class="btn btn-lg btn-primary btn-block" id="btn_login" value="LOGIN" name="submit">
                                <br>
                                <a href="registrationform_doctor.php" ><b><u>Register Now</u></b></a>

                                <a href="forgetpassword_doctor.php" style="margin-left: 115px;"><u>Forget Password</u></b></a>
                            </fieldset>
                        </form>
                    </div>
                </div>
