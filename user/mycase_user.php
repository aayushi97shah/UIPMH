      ...
      $("#patient_reg_form").on('submit',function(e){
        ...
        $.ajax({    //create an ajax request to load_page.php
         ...
         // alert(response);
          ...
          {
            alert("now enter detail of report");
				...
				<div class="custom_tab_2 row" >
                    ...
                    <div class="col-md-12" >
                        <div class="tab-content">
                            ...
                            <input type="date" name="date_disease" >
                            </div>
                                 ...
                                 <label>Name Of Disease</label>
                                  <input type="text" class="form-control" name="disname_txt" id="full_name" placeholder="Enter Disease Name" required  data-parsley-pattern="^[a-zA-Z\s]*$" title="only character" pattern="^[a-zA-Z\s]*$">
                                    </div>
                                  <label>Medicines</label>
                                   <div class="form-group">
                                  
                                  <textarea  rows="5" cols="110" name="medname_txt"></textarea >
                                  <div class="form-group">
                                    <label for="exampleInputFile">Add Prescription</label>
                                  ...
                                  <textarea  rows="5" cols="110" name="rname_txt"></textarea >
                                  </div>
