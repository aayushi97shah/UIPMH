            ...
            <div class="col-md-4 col-md-offset-4 animated bounceInDown">
                <div class="login-panel panel panel-default" style="margin-top:67px; margin-bottom: 67px;">
                    ...
                    <div class="panel-body">
                        <form role="form" action="common/checklogin_lab.php" method="post" data-parsley-validate id="login_form">
                        ...
                        ?>
                                ...
                                <input type="submit" class="btn btn-lg btn-primary btn-block" name="submit" id="btn_login" value="LOGIN">
                                <br>
                                <a href="registrationform_lab.php" ><b><u>Register Now</u></b></a>

                                <a href="forgetpassword_lab.php" style="margin-left: 115px;" ><b><u>Forget Password</u></b></a>
                            </fieldset>
                        </form>
                    </div>
                </div>
