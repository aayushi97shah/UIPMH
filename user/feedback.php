...
<div class="loader">Loading...</div>
	...
	<div class="white-wrapper" style="background-color: #fff;">              <?php require "sidemenu.php";?>
    	<div class="container">
                  ...
                  <div id="message"></div>  <label>Profile Pic:</label>
                        ...
                        <div style="float: left;  padding-left: 20px;">
                         <div >
                            ...
                            <textarea class="form-control" id="comments" name="post_txt" required autofocus data-parsley-pattern="^[a-zA-Z\s]*$" title="only character" pattern="^[a-zA-Z\s]*$"></textarea>
                            </div>
                            <div class="clearfix"></div>
                            <div class="col-md-12">
                            <div >
