...
<script src="js/jquery.js" type="text/javascript"></script>
  ...
  $(document).ready(function() {
      ...
      $("#patient_reg_form").on('submit',function(e){
        ...
        //  alert(response);
            if($.trim(response)=='lab_report.php')
          {
                ...
                <h3>Case Id:</h3>
                              ...
                              <div class="form-group">
                                 <label>Report Name</label>
                                  <input type="text" class="form-control" name="report_name" id="full_name" placeholder="Enter Report Name" required  data-parsley-pattern="^[a-zA-Z\s]*$" title="only character" pattern="^[a-zA-Z\s]*$">
                                    </div>
...
{
  header('location:lab_report_id.php?er_ms=you have enter wrong case_id');
}
