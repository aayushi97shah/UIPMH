...
$sel15="SELECT * FROM patient WHERE user_id='".$up."'";
                        ...
                        <div class="tab-content">
                            ...
                            <div class="doc">
                                ...
                                <form role="form" method="post" action="#" data-parsley-validate id="patient_reg_form">
                                  ...
                                  <input type="text" name="fnm_txt" class="form-control" id="full_name" placeholder="Full Name (required)" required autofocus data-parsley-pattern="^[a-zA-Z]*$" title="only character" value="<?php echo $data15['pname_txt']?>" pattern="^[a-zA-Z\s]*$">
                                    </div>

                                  <div class="form-group">    
                                  <label>Address</label>
                                  <input type="text" class="form-control" name="adr" id="Address" placeholder="Resident Address (required)" required autofocus data-parsley-pattern="^[a-zA-Z\s][0-9\s]*$" title="only character" value="<?php echo $data15['address']?>" pattern="^[a-zA-Z0-9 ,\s]*$">
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <br><?php $gn=$data15['gender']; 
                                     ...
                                     <div class="form-group">
                                     <label>Age</label>
                                  <input type="text" class="form-control" name="age" id="Age" placeholder="Age(required)" required autofocus  data-parsley-maxlength="3"  title="only Number" value="<?php echo $data15['age']?>" pattern="^[0 -9]{1,3}" >
                                  </div>
                                  ...
                                  <label>Blood Group</label>
                                   ...
                                   <?php
                                    ...
                                    <input type="email" name="user_id" class="form-control" id="exampleInputEmail1" value="<?php echo $data15['user_id']?>" placeholder="Enter User Id" readonly="" required>
                                  </div>


                                  <div class="form-group">
                                    <label for="exampleInputPassword1">Password</label>
                                    <input type="password" name="password" class="form-control" id="exampleInputPassword1" value="<?php echo $data15['password']?>" placeholder="Password" required>
                                  </div>

                                     <div class="form-group">
                                    <label for="exampleInputPassword1">Confirm Password</label>
                                    <input type="password" name="c_password" class="form-control" id="exampleInputPassword1" value="<?php echo $data15['c_password']?>" placeholder="Password" required>
                                  </div>
                                  ...
                                  <input type="text" class="form-control" name="sanswer_txt" id="sanswer" placeholder="security answer (required)" value="<?php echo $data15['sq_ans']?>" required autofocus>
                                    </div>
